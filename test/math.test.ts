...
import 'mocha';
import {
    getRanInter, getRanInters, getDiverseRanInter, getDiverseRanInters,
    getRanIndexByProportion,
} from '../src/math';
...
describe('用getRanInter方法获取两个数之间的随机一个数', () => {
    ...
    it('从10到15之间获取一个随机，随机获取1000次，并且每次获取的值都是大于等于10且小于等于15', () => {
        ...
        const everyFunc = (num: number) => num >= 10 && num <= 15;
...
describe('用getRanIndexByProportion按比例获取一个随机数', () => {
    it('按[10,20,30,40]的比例获取一个随机数100000次，获取0、1、2、3的概率大概为10%、20%、30%、40%，即获取0的次数大于9%小于11%', () => {
